...
from .types import _datamodel_types, _datamodel_asdf_types


__all__ = ['AstronomyDataModelExtension', 'AstronomyDataModelAsdfExtension']


SCHEMA_URI_BASE = 'http://stsci.edu/schemas/'
...
class AstronomyDataModelExtension(AsdfExtension):
    @property
    def types(self):
        return _datamodel_types

    @property
    def tag_mapping(self):
        return [('tag:astropy.org:astropy',
                 ASTRONOMY_DATAMODEL_SCHEMA_URI_BASE + 'astropy{tag_suffix}')]
